...
def f_multibody(u, acc):
    ...
    """ Add accelerations due to force generated by burn (parallel to heading) """
...
def init_multibody():
    ...
    a = 185000 + 6371000            # Radius initial circular orbit
    v = math.sqrt(masses[0]*G/a)    # Velocity of circular orbit

    #        Earth      Moon          You
    return [0,          x_moon,     (185000 + 6371000)*np.cos(theta),   # x-position (Earth at origin)
            0,          0,          (185000 + 6371000)*np.sin(theta),   # y-position
